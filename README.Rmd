...
Here's how to construct a wrapper around the OpenAI API. A more complete implementation of this is found in the [`examples/openai`](examples/openai) directory.
